...
if __name__ == "__main__":
    ...
    for scenario in scenarios:
        ...
        pd.DataFrame([global_res]).to_csv(f"{prefix}no_patch_global_result.csv", index=False)
        pd.DataFrame(per_asset_res).to_csv(f"{prefix}no_patch_per_asset_results.csv", index=False)
